    ...
    <section>
      <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="home.html">Mosai<span>c</span></a></h1>
			</div>
			<div class="logo-icon text-center">
				<a href="home.html">M </a>
			</div>
 	 <!-- /w3l-agile -->
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						<li class="active"><a href="home.html"><i class="lnr lnr-home"></i><span>Home</span></a></li>
					...
					<!--//pop-up-box -->
						<div class="albums">
								<div class="tittle-head">
									...
									<a href="home.html"><h4 class="tittle">See all</h4></a>
									<div class="clearfix"> </div>
								</div>
					...
					<!--//End-albums-->
						...
						<div class="albums second">
										<div class="tittle-head">
											...
											<a href="home.html"><h4 class="tittle two">See all</h4></a>
											<div class="clearfix"> </div>
										</div>
											<div class="col-md-3 content-grid">
